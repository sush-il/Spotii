...
export default function Navbar() {
  ...
  const moodMouseEnter = () => {
    setIsMoodHovered(true);
  };
  const moodMouseLeave = () => {
      ...
      <div
        ...
        <Link to='/'>
          <img
            ...
            style={{
              ...imageStyles,
              transform: isHomeHovered ? "scale(1.1) translate(5%)" : "none",
            }}
            alt='Home Image'
        ...
        <Link to='/mood'>
          <img
            ...
            style={{
              ...imageStyles,
              transform: isMoodHovered ? "scale(1.1) translate(5%)" : "none",
            }}
            onMouseEnter={moodMouseEnter}
            onMouseLeave={moodMouseLeave}
            alt='Mood Image'
          />
        </Link>
      </div>
